...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, de.subjektiv_news.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, de.subjektiv_news.repository.UserRepository.USERS_BY_EMAIL_CACHE);
