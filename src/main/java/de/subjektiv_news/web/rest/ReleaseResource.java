...
public class ReleaseResource {
    ...
    public ResponseEntity<ReleaseDTO> updateRelease(@Valid @RequestBody ReleaseDTO releaseDTO) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, releaseDTO.getId().toString()))
            .body(result);
    }
     ...
     */
    @GetMapping("/releases")
    public ResponseEntity<List<ReleaseDTO>> getAllReleases(Pageable pageable) {
