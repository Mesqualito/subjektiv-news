...
import { KeywordSubComponent } from 'app/entities/keyword-sub/keyword-sub.component';
...
describe('Component Tests', () => {
  describe('KeywordSub Management Component', () => {
    let comp: KeywordSubComponent;
    let fixture: ComponentFixture<KeywordSubComponent>;
    let service: KeywordSubService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [SubjektivTestModule],
        declarations: [KeywordSubComponent],
        providers: [
          {
        ...
        .overrideTemplate(KeywordSubComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(KeywordSubComponent);
