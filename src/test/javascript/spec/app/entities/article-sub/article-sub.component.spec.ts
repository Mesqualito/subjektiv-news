...
import { ArticleSubComponent } from 'app/entities/article-sub/article-sub.component';
...
describe('Component Tests', () => {
  describe('ArticleSub Management Component', () => {
    let comp: ArticleSubComponent;
    let fixture: ComponentFixture<ArticleSubComponent>;
    let service: ArticleSubService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [SubjektivTestModule],
        declarations: [ArticleSubComponent],
        providers: [
          {
        ...
        .overrideTemplate(ArticleSubComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(ArticleSubComponent);
