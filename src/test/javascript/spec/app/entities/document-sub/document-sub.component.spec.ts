...
import { DocumentSubComponent } from 'app/entities/document-sub/document-sub.component';
...
describe('Component Tests', () => {
  describe('DocumentSub Management Component', () => {
    let comp: DocumentSubComponent;
    let fixture: ComponentFixture<DocumentSubComponent>;
    let service: DocumentSubService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [SubjektivTestModule],
        declarations: [DocumentSubComponent],
        providers: [
          {
        ...
        .overrideTemplate(DocumentSubComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(DocumentSubComponent);
