...
import { ReleaseSubComponent } from 'app/entities/release-sub/release-sub.component';
...
describe('Component Tests', () => {
  describe('ReleaseSub Management Component', () => {
    let comp: ReleaseSubComponent;
    let fixture: ComponentFixture<ReleaseSubComponent>;
    let service: ReleaseSubService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [SubjektivTestModule],
        declarations: [ReleaseSubComponent],
        providers: [
          {
        ...
        .overrideTemplate(ReleaseSubComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(ReleaseSubComponent);
